...
export default function Chat() {
  ...
  return (
    <div className="flex h-screen bg-[#050505]">
          ...
          {sessions.map((session) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                >
                  <img src={RenameImage} alt="rename" className="w-3.5 h-3.5 opacity-70" />
                </button>
                ...
                >
                  <img src={DeleteImage} alt="delete" className="w-3.5 h-3.5 opacity-70" />
                </button>
              </div>
            </motion.div>
          ))}
      ...
      <div className="flex flex-col flex-1 bg-gradient-to-b from-zinc-950 to-black">
        <div className="sticky top-0 z-10 border-b border-zinc-800/50 backdrop-blur-xl bg-zinc-950/80">
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-3 text-left">
                  {[
                    ...
                    "Execute a transaction on Cardano",
                  ].map((suggestion, i) => (
                    <motion.button
                      key={i}
        ...
        <div className="relative border-t border-zinc-800/50 bg-zinc-950/50 backdrop-blur-xl">
